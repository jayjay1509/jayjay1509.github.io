...
1. [Presentation of Namakemono Engine](#presentation-of-namakemono-engine)
2. [Features of Namakemono Engine](#features-of-namakemono-engine)
    - [Applying Forces](#applying-forces)
    - [Collision Management](#collision-management)
    - [Trigger Management](#trigger-management)
3. [Testing Namakemono Engine](#testing-namakemono-engine)
4. [Engine Classes](#engine-classes)
